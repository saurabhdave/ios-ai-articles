...
images/     Cover images generated by Google Imagen 3 (16:9 PNG, one per article)
...
Articles are generated by [ios-dev-ai-writer](https://github.com/saurabhdave/ios-dev-ai-writer) (v0.4.0). Swift code samples are validated against Swift 6.2.4 via `swiftc`; the `codegen/` JSON files record diagnostics and repair attempts for each run. Cover images are generated with Google Imagen 3 and served alongside articles on the blog.
